...
class TestSolidSprite {
    SolidSprite sprite;
    SolidSprite spriteWithOffset;
    ...
    void setup() {
        ...
        try {
            sprite = new SolidSprite(new Vector2d(0, 0), "src/main/resources/Hero/Running/running0.png");
            spriteWithOffset = new SolidSprite(new Vector2d(0, 0), new Vector2d(1, 1), "src/main/resources/Hero/Running/running0.png");
    ...
    void testDraw1() {
        ...
        Mockito.verify(graphicsStub, Mockito.times(1)).drawImage(Mockito.any(TerminalPosition.class), Mockito.any(TextImage.class));
    }

    @Test
    void testDraw2() {
        //Drawing with flipped image
        sprite.xFlip();
